...
export const GetAnimeListDocument = `
  ...
  Page(page: $page, perPage: $perPage) {
    ...
    `;
export const useGetAnimeListQuery = <TData = GetAnimeListQuery, TError = unknown>(
  variables?: GetAnimeListQueryVariables,
  options?: UseQueryOptions<GetAnimeListQuery, TError, TData>
) =>
  useQuery<GetAnimeListQuery, TError, TData>(
    variables === undefined ? ['GetAnimeList'] : ['GetAnimeList', variables],
    fetcher<GetAnimeListQuery, GetAnimeListQueryVariables>(GetAnimeListDocument, variables),
    options
  );
